			...
			var b = (function() {
				...
				(function() {
					if (!d || !d.requirejs) {
						...
						var f, e, g;
						(function(l) {
							var o, h, s, t, k = {}, j = {}, z = {}, w = {}, r = Object.prototype.hasOwnProperty, p = [].slice, q = /\.js$/;
							function A(B, C) {
								return r.call(B, C)
							}
							function u(E, C) {
								var M, I, G, J, N, F, P, Q, L, K, H, O = C
										&& C.split("/"), D = z.map, B = (D && D["*"])
										|| {};
								if (E && E.charAt(0) === ".") {
									if (C) {
										E = E.split("/");
						...
						.define(
								...
								function() {
									...
									if (e == null && console && console.error) {
										console
												.error("Select2: An instance of jQuery or a jQuery-compatible library was not found. Make sure that you are including jQuery before Select2 on your web page.")
									}
									return e
								});
				d.define("select2/utils", [ "jquery" ], function(h) {
					...
					e.prototype.trigger = function(i) {
						...
						if (i in this.listeners) {
							this
									.invoke(this.listeners[i], k.call(
											arguments, 1))
						}
					...
					g.hasScroll = function(k, m) {
						...
						return (l.innerHeight() < m.scrollHeight || l
								.innerWidth() < m.scrollWidth)
					};
						...
						.define(
								...
								function(g, f) {
												...
												.current(function(k) {
													...
													i
															.each(function() {
																...
																var n = ""
																		+ l.id;
																if ((l.element != null && l.element.selected)
																		|| (l.element == null && g
																				.inArray(
																						n,
																						j) > -1)) {
									...
									e.prototype.bind = function(h, j) {
										...
										h.on("open", function() {
											i.$results.attr("aria-expanded",
													"true");
											i.$results.attr("aria-hidden",
													"false");
											i.setClasses();
						...
						.define(
								...
								function(h, g, e) {
									...
									f.prototype.bind = function(i, l) {
										...
										i.on("open", function() {
											k.$selection.attr("aria-expanded",
													"true");
												...
												.on(
														...
														function() {
															...
															k.$selection
																	.focus();
															k
																	._detachCloseHandler(i)
														});
										i.on("enable", function() {
											k.$selection.attr("tabindex",
													k._tabindex)
										});
									...
									f.prototype._handleBlur = function(i) {
										...
										window
												.setTimeout(
														function() {
															if ((document.activeElement == j.$selection[0])
																	|| (h
																			.contains(
																					j.$selection[0],
									...
									f.prototype._attachCloseHandler = function(
											i) {
										var j = this;
										h(document.body)
												.on(
									...
									f.prototype._detachCloseHandler = function(
											i) {
										h(document.body).off(
				...
				d
						.define(
								...
								function(h, f, g, e) {
									function i() {
										i.__super__.constructor.apply(this,
												arguments)
									}
									g.Extend(i, f);
									i.prototype.render = function() {
										...
										j
												.html('<span class="select2-selection__rendered"></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>');
										return j
									};
				...
				d
						.define(
								...
								function(h, e, g) {
									function f(i, j) {
										f.__super__.constructor.apply(this,
												arguments)
									}
									g.Extend(f, e);
									f.prototype.render = function() {
				...
				d
						.define(
								...
								function(f) {
									...
									e.prototype.createPlaceholder = function(h,
											i) {
				...
				d
						.define(
								...
								function(f, e) {
									...
									g.prototype.bind = function(j, h, k) {
										...
										if (this.placeholder == null) {
											if (this.options.get("debug")
													...
													&& console.error) {
												console
														.error("Select2: The `allowClear` option should be used in combination with the `placeholder` option.")
											}
										}
										this.$selection.on("mousedown",
									...
									g.prototype._handleKeyboardClear = function(
											j, i, h) {
										if (h.isOpen()) {
											return
										}
				...
				d
						.define(
								...
								function(h, g, e) {
												...
												.on(
														...
														function(o) {
															...
															if (q === e.BACKSPACE
																	&& k.$search
																			.val() === "") {
																var p = k.$searchContainer
																		.prev(".select2-selection__choice");
																if (p.length > 0) {
																	var r = p
																			.data("data");
																	k
																			.searchRemoveChoice(r);
																	o
																			.preventDefault()
																}
															}
									...
									f.prototype.createPlaceholder = function(i,
											j) {
										this.$search
												.attr("placeholder", j.text)
									};
									...
									f.prototype.searchRemoveChoice = function(
											j, i) {
				...
				d.define("select2/selection/eventRelay", [ "jquery" ],
						function(e) {
							function f() {
							}
							f.prototype.bind = function(k, g, l) {
								var h = this;
								var i = [ "open", "opening", "close",
										"closing", "select", "selecting",
										"unselect", "unselecting" ];
								var j = [ "opening", "closing", "selecting",
										"unselecting" ];
								k.call(this, g, l);
								g.on("*", function(n, o) {
									if (e.inArray(n, i) === -1) {
				...
				d.define("select2/translation", [ "jquery", "require" ],
						function(g, f) {
							function e(h) {
