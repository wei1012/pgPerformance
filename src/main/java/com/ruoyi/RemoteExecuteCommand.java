...
public class RemoteExecuteCommand {  
    ...
    */  
    ...
    public static void main(String[] args) {  
        RemoteExecuteCommand rec=new RemoteExecuteCommand("211.159.179.14", "root","Wei10121012");  
        //执行命令  
        System.out.println(rec.execute("ifconfig"));
        System.out.println(rec.execute("ls"));
        rec.execute("cd /usr/software/apache-jmeter-4.0/bin ");
        System.out.println(rec.execute("ls"));
        System.out.println(rec.execute(" /usr/software/apache-jmeter-4.0/bin/jmeter.sh -n -t test1.jmx -l wweasr.jtl"));  
        //执行脚本  
